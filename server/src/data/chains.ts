...
export const CHAINS: ChainSeed[] = [
  {
    ...
    subtitle: '口袋里的全球供应链',
    description:
      '一部手机汇集了刚果的钴、南美的锂、印尼的镍；矿产首先在资源国开采，再经材料精炼与核心器件制造，由品牌组织设计并在中国、越南、印度组装，最终进入美国、中国与印度等消费市场。',
    stages: [
    ...
    nodes: [
      { code: 'COD', stage: 'raw_material', role: '钴矿主产国', detail: '全球约七成钴产量，电池稳定性关键原料', weight: 7 },
      { code: 'CHL', stage: 'raw_material', role: '锂资源大国', detail: '阿塔卡马盐湖；碳酸锂重要来源', weight: 6 },
      { code: 'IDN', stage: 'raw_material', role: '镍矿主产国', detail: '全球最大镍生产国；电池与不锈钢原料', weight: 6 },
      { code: 'AUS', stage: 'raw_material', role: '锂矿出口国', detail: '格林布什硬岩锂矿，精矿运往中国精炼', weight: 7 },

      { code: 'CHN', stage: 'production', role: '电池材料生产', detail: '锂、钴、镍精炼与正负极材料的主要生产基地', weight: 9 },
      { code: 'JPN', stage: 'production', role: '精密材料生产', detail: 'CMOS 传感器、被动元件与电子化学品', weight: 7 },
      { code: 'TWN', stage: 'production', role: '晶圆生产', detail: '台积电代工苹果与安卓旗舰处理器芯片', weight: 9 },
      { code: 'USA', stage: 'production', role: '芯片设计与产品定义', detail: '苹果自研芯片、EDA 工具、关键 IP 与整机产品定义', weight: 8 },
      { code: 'KOR', stage: 'production', role: '面板存储与品牌设计', detail: '三星显示、存储芯片与高端手机品牌的设计能力', weight: 8 },

      { code: 'CHN', stage: 'processing', role: '核心模组加工', detail: '电池模组、连接器、结构件和整机零部件完整配套', weight: 8 },
      { code: 'KOR', stage: 'processing', role: '屏幕 / 存储模组', detail: '显示模组、存储与核心被动元件向组装厂交付', weight: 8 },
      { code: 'JPN', stage: 'processing', role: '精密元器件加工', detail: '摄像头、传感器与微型元器件加工', weight: 6 },
      { code: 'TWN', stage: 'processing', role: '处理器封测交付', detail: '晶圆制造后完成封装测试，交付手机组装基地', weight: 7 },

      { code: 'CHN', stage: 'assembly', role: '全球最大组装基地', detail: '富士康等代工厂组装全球多数 iPhone 与安卓旗舰', weight: 9 },
      { code: 'VNM', stage: 'assembly', role: '新兴组装中心', detail: '富士康、三星产能转移；对美出口快速增长', weight: 7 },
      { code: 'IND', stage: 'assembly', role: '成长中的组装基地', detail: '苹果供应链转移；面向本土大市场组织生产', weight: 6 },

      { code: 'USA', stage: 'consumption', role: '高端手机最大利润市场', detail: '高 ASP 市场，品牌利润与应用服务收入集中', weight: 8 },
      { code: 'CHN', stage: 'consumption', role: '最大智能手机市场', detail: '国产与国际品牌充分竞争，换机规模庞大', weight: 8 },
      { code: 'IND', stage: 'consumption', role: '增长最快的大市场', detail: '功能机转智能机红利带来持续增量', weight: 7 },
      { code: 'DEU', stage: 'consumption', role: '欧洲核心市场', detail: '高端机型需求稳定，是亚洲整机的重要目的地', weight: 5 },
    ],
    edges: [
      { from: 'COD', to: 'CHN', fromStage: 'raw_material', toStage: 'production', label: '钴原料', value: 7 },
      { from: 'CHL', to: 'CHN', fromStage: 'raw_material', toStage: 'production', label: '锂盐', value: 5 },
      { from: 'IDN', to: 'CHN', fromStage: 'raw_material', toStage: 'production', label: '镍产品', value: 6 },
      { from: 'AUS', to: 'CHN', fromStage: 'raw_material', toStage: 'production', label: '锂精矿', value: 6 },
      { from: 'AUS', to: 'KOR', fromStage: 'raw_material', toStage: 'production', label: '锂精矿', value: 3 },

      { from: 'CHN', to: 'CHN', fromStage: 'production', toStage: 'processing', label: '电池材料 / 结构件', value: 9 },
      { from: 'KOR', to: 'KOR', fromStage: 'production', toStage: 'processing', label: '屏幕 / 存储模组', value: 8 },
      { from: 'JPN', to: 'JPN', fromStage: 'production', toStage: 'processing', label: '传感器元件', value: 6 },
      { from: 'TWN', to: 'TWN', fromStage: 'production', toStage: 'processing', label: '晶圆封测', value: 8 },

      { from: 'CHN', to: 'CHN', fromStage: 'processing', toStage: 'assembly', label: '电池 / 结构件', value: 8 },
      { from: 'CHN', to: 'VNM', fromStage: 'processing', toStage: 'assembly', label: '零部件', value: 6 },
      { from: 'CHN', to: 'IND', fromStage: 'processing', toStage: 'assembly', label: '零部件', value: 5 },
      { from: 'KOR', to: 'VNM', fromStage: 'processing', toStage: 'assembly', label: '屏幕 / 存储', value: 7 },
      { from: 'JPN', to: 'CHN', fromStage: 'processing', toStage: 'assembly', label: '精密元器件', value: 6 },
      { from: 'TWN', to: 'CHN', fromStage: 'processing', toStage: 'assembly', label: '处理器芯片', value: 8 },
      { from: 'TWN', to: 'VNM', fromStage: 'processing', toStage: 'assembly', label: '芯片', value: 7 },
      { from: 'USA', to: 'CHN', fromStage: 'production', toStage: 'assembly', label: '苹果设计与订单', value: 8 },
      { from: 'USA', to: 'VNM', fromStage: 'production', toStage: 'assembly', label: '品牌供应链组织', value: 6 },
      { from: 'KOR', to: 'VNM', fromStage: 'production', toStage: 'assembly', label: '三星品牌订单', value: 6 },

      { from: 'CHN', to: 'USA', fromStage: 'assembly', toStage: 'consumption', label: '手机整机', value: 7 },
      { from: 'VNM', to: 'USA', fromStage: 'assembly', toStage: 'consumption', label: '手机整机', value: 8 },
      { from: 'VNM', to: 'DEU', fromStage: 'assembly', toStage: 'consumption', label: '手机整机', value: 5 },
      { from: 'CHN', to: 'CHN', fromStage: 'assembly', toStage: 'consumption', label: '本土产销', value: 8 },
      { from: 'IND', to: 'IND', fromStage: 'assembly', toStage: 'consumption', label: '本土组装销售', value: 6 },
    ],
  },
  {
    id: 'oil',
