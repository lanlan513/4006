...
- 人口数据模式：总人口、人口增长率、老龄化率、城市化率、劳动力规模五项指标，连续色带着色。
- 人口结构与经济关联模式：动态散点图，X 轴固定为劳动力人口比例、Y 轴固定为人均 GDP、气泡大小为总人口；坐标轴范围基于全年份数据一次性锁定，播放时间轴时气泡在固定坐标系内平滑迁移，不发生轴域跳变。
- 时间轴支持 2000、2005、2010、2015、2020、2023 六个年度切换。
- 支持播放时间轴，观察指标和全球经济规模变化。
- 点击国家查看年度经济概览（含人口数据与年龄结构金字塔），并进入国家画像。
- 地图缩放、拖拽和悬浮提示。
- 打开全球贸易网络后，展示主要双边贸易流；选中国家后可聚焦其贸易伙伴。
- 拆分视图：左侧为选定指标的地图，右侧展示该国历史人口（总人口 × 劳动力）与 GDP（总量 × 人均）的双 Y 轴折线，虚线标记随时间轴年份平滑移动。
- 双国对比：拆分视图中选择对照国后，在同一张双轴折线图中叠加两国 GDP 增速（实线）与人口增长率（虚线）的历史轨迹。

### 国家经济画像

- 展示最新年度 GDP、人均 GDP、人口、出口、进口和贸易差额。
- 展示 GDP、出口与进口、实际 GDP 增速的历史图表。
- 人口年龄结构金字塔：0-14 岁、15-64 岁劳动年龄、65 岁及以上三段占比，支持切换六个年度，并联动展示抚养比、劳动力规模与人均 GDP。
...
```text
client/src/
  components/   地图、图表、时间轴、金字塔、动态散点、产业链流程等可复用组件
  pages/        探索地图、国家画像、产业链页面
  api.ts        前端 API 类型和请求层
  store.ts      年份、选中国家、指标、分析模式和贸易网络状态
server/src/
